    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fafafa', padding: '2rem' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          <h1 style={{ fontSize: '2rem', fontWeight: '700', color: '#000', marginBottom: '0.5rem', letterSpacing: '-1px' }}>E-Shop</h1>
          <p style={{ color: '#737373', fontSize: '0.95rem', fontWeight: '500' }}>Welcome back</p>
        </div>
        ...
        <div style={{ background: '#fff', border: '1px solid #e5e5e5', borderRadius: '12px', padding: '2.5rem' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <input type="password" name="password" value={formData.password} onChange={handleChange} required placeholder="••••••••" style={{ width: '100%', padding: '0.875rem 1rem', border: '1.5px solid #d4d4d4', borderRadius: '8px', fontSize: '0.95rem', outline: 'none' }} />
            </div>

            <button type="submit" disabled={loading} style={{ width: '100%', padding: '0.875rem', background: loading ? '#d4d4d4' : '#000', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '0.95rem', fontWeight: '600', cursor: loading ? 'not-allowed' : 'pointer' }}>{loading ? 'Signing in...' : 'Sign in'}</button>
          </form>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
          <span style={{ color: '#737373', fontSize: '0.9rem' }}>Don't have an account? </span>
          <Link to="/register" style={{ color: '#000', fontWeight: '600', textDecoration: 'none', fontSize: '0.9rem' }}>Sign up</Link>
        </div>
      </div>
    </div>
  );
